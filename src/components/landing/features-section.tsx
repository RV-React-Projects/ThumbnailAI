            ...
            >
              ...
              <div className="flex justify-center gap-8 text-sm">
                <div className="text-center">
                  <div className="text-2xl font-bold text-amber-300">87%</div>
                  <div className="text-emerald-200">Avg. CTR Increase</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-amber-300">2.3x</div>
                  <div className="text-emerald-200">Faster Creation</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-amber-300">95%</div>
                  <div className="text-emerald-200">User Satisfaction</div>
                </div>
              </div>
            </motion.div>
          </div>
